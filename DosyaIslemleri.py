...
# bir blok olusturulur ve blok icersinde dosya islemleri yapilir
# islem sonunda dosyanin kapatilmasina gerek yoktur
with open('/root/Desktop/dosyam.txt', 'a+') as dosyadan:
        dosyadan.write('\nPamukkale Universitesi \n')
        dosyadan.write('Denizli')

        # Dosya imlecini dosyanin sonundan basina tasimak
        # icin seek fonksiyonu kullanilir.
        dosyadan.seek(0)
